...
wd08 <- "output08_analysis_of_ddpcr0030"
...
lst.f.wd00_wd01 <- list.files(wd00_wd01, full.names = T)
#grep for the '.csv' files in the directory, and place in a list
lst_fcsv <- lst.f.wd00_wd01[grep("\\.csv",lst.f.wd00_wd01)]
...
# or just use the unmodified copy count inferred by qPCR
...
plt07  <- plt07 + labs(title = "standard dilution series for ddPCR and qPCR")#,
...
fgNm07 <- paste0(wd00_wd08,"/Fig02_v01",inf02_1,".png")
...
#plt08
fgNm08 <- paste0(wd00_wd08,"/Fig02_v02",inf02_1,".png")
# save the plot as png file if 'bSaveFigures' is set to be TRUE
bSaveFigures <- TRUE
if(bSaveFigures==T){
...
fnm02 <- paste0(wd00_wd08,"/Fig0030_",inf02_1,".png")
